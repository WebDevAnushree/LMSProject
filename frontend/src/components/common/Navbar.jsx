...
//     return (
//         <nav className={`z-[9999] flex h-14 w-full items-center justify-center border-b-[1px] border-b-richblack-700 text-white translate-y-0 transition-all ${showNavbar} `}>
//             <div className='flex w-11/12 max-w-maxContent items-center justify-between '>
//                 {/* logo */}
//                 <Link to="/">
//                     <img src={studyNotionLogo} width={160} height={42} loading='lazy' />
...
//                                                             {subLinks?.map((subLink, i) => (
//                                                                 <Link
//                                                                     // ✅ FIXED: replace "/" with "-" to avoid broken URLs like /catalog/ai/ml
//                                                                     to={`/catalog/${subLink.name
//                                                                         .split(" ")
//                                                                         .join("-")
//                                                                         .replace(/\//g, "-")
