        ...
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
          ...
          <div className="text-center flex flex-col sm:flex-row ">
            <div className="flex ">
              ...
              <Link to='https://github.com/WebDevAnushree' target="__blank" className="text-white hover:underline mr-1"
              >
                Anushree Joshi
              </Link>
            </div>
          ...
          <div className="flex items-center">
            <a href="https://www.linkedin.com/in/anushree-joshi-03457a310" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImLinkedin2 size={17} />
            </a>
            <a href="https://github.com/WebDevAnushree" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImGithub size={17} />
            </a>
          </div>
